...
public class HtmlParser6 extends JPanel implements ActionListener {
	...
	public void processURL(File file) {
		...
		try {
			...
			Elements items = doc.select("a.purchase-resellers__reseller");
	...
	public static void main(String s[]) {
		...
		HtmlParser6 panel = new HtmlParser6();
