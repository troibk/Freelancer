...
public class HtmlParser5 extends JPanel implements ActionListener{
	...
	public void processTXT(File file) {
		...
		try {
			 ...
			 Elements apply_infos = doc.select("div.partner-regular");
			 
			 for (Element element: apply_infos) {
				 Element title = element.selectFirst("div.partner-title");
				 
				String url=title.select("a").first().attr("href");
				String companyName= title.text();
				String phone = element.selectFirst("div.partner-phone").text();
	...
	public static void main(String s[]) {
		...
		HtmlParser5 panel = new HtmlParser5();
