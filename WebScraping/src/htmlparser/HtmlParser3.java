...
public class HtmlParser3 extends JPanel implements ActionListener{
	...
	public void processTXT(File file) {
		...
		try {
			 ...
			 Elements apply_infos = doc.select("div.apply-info");
			 
			 for (Element element: apply_infos) {
				String url=element.select("a").first().attr("href");
				doc = Jsoup.connect(url).get();
				String website= doc.select("#MainContent_aWebsite").attr("href");
	...
	public static void main(String s[]) {
		...
		HtmlParser3 panel = new HtmlParser3();
