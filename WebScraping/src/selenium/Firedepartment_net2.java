...
public class Firedepartment_net2 {
	static WebDriver driver;
	List<String[]> datalist = new ArrayList<>();
	String fileName = "firedepartment.net_sample.xlsx";
	String fileResult = "firedepartment.net_sample_result.xlsx";

	public Firedepartment_net2() {
	...
	public static void main(String[] args) {
		...
		Firedepartment_net2 t = new Firedepartment_net2();
//		t.processWeb(url);
		 t.processExcel();
			...
			if (table1Sheet == null) {
				...
				for (int i = 0; i < table1Sheet.getPhysicalNumberOfRows(); i++) {
					try {
						...
						String name2 = table1Sheet.getRow(i).getCell(1).getStringCellValue();
						String name = table1Sheet.getRow(i).getCell(2).getStringCellValue();
						String state = table1Sheet.getRow(i).getCell(3).getStringCellValue();
						if(processWeb2(link,name2, name, state, (i+1))){
							if(i%50==0) {
